            ...
            <div class="x_panel">
                <div class="x_title">
                    ...
                    <div class="col-xs-12 col-sm-1 col-md-1">
                            <a href="{{route('blogs.add')}}" class="btn btn-primary"><i class="fa fa-plus"></i>&nbsp; Add</a>
                    </div>
                                ...
                                <tbody>
                                    @foreach($blogList as $blog)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{route('posts.featured',['id' => $blog->id])}}">
                                                    @if($blog->featured)
                                            ...
                                            <td>
                                                <a href="{{route('blogs.edit',['id' => $blog->id])}}" class="btn btn-primary btn-round">
                                            ...
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <h4>You are about to delete the blog ( {{ $blog->title }} )</h4>
                                                        <p>Once the blog is deleted it cannot be recovered.</p>
                                                    </div>
