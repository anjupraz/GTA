...
<div class="right_col" role="main">
    <form method="post" action="{{route('blogs.update',['id' => $blog->id])}}" class="form-horizontal form-label-left" enctype="multipart/form-data" novalidate>
        @csrf
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-8">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>
                            Blogs<small>[ code : {{$blog->code}} ]</small>@if($blog->slug)<small>[ slug : <a href="https://gtanepal.org/blog/{{$blog->slug}}" target="_blank"><strong>https://gtanepal.org/blog/{{$blog->slug}}</strong></a> ]</small>@endif
                        </h2>
                    ...
                    <div class="x_content">
                        <div class="item form-group @error('title') bad @enderror">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <input type="hidden" hidden="hidden" name="slug" value="{{old('slug',$blog->slug)}}">
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <textarea id="description" name="description" required="required" class="form-control col-md-7 col-xs-12 summernote">{{old('description',$blog->description)}}</textarea>
                            </div>
                            @error('description')
                                <div class="alert">{{$message}}</div>
                            @enderror
