...
<div class="right_col" role="main">
    <form method="post" action="{{route('services.save')}}" class="form-horizontal form-label-left" enctype="multipart/form-data" novalidate>
        @csrf
        <div class="row">
...
@section('script')
    ...
    <script>
        $('#title').change(function(){
            ...
            var title=$('#title').val();
            var slug="service-"+title.replace(/\s/g,"-")+"-"+current_year;
