...
<div class="right_col" role="main">
    <form method="post" action="{{route('impact.save')}}" class="form-horizontal form-label-left" enctype="multipart/form-data" novalidate>
        @csrf
        <div class="row">
...
@section('script')
    ...
    <script>
        $('#title').change(function(){
            ...
            var title=$('#title').val();
            var slug="impact-"+title.replace(/\s/g,"-")+"-"+current_year;
